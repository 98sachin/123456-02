...
var taskModel = document.querySelector(".task__modal__body");

// console.log(taskContents);

// dynamic card creations
var htmlTaskContent = ({id, title, description, type, url}) => // we use backticks(``) to write html code in javascript file. similarly to use javascript in html use "${...}".
    `
...
// func is called whenever we need to update browser's local storage from the taskList array
